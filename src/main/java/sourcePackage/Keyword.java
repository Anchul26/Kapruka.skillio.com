...
import sganalytics.exceptions.InvalidBrowserNameException;
/**
 * This class contains all the keywords related to selenium web driver. Keywords 
 * are nothing but methods which will perform some action on browser or on the
 * Web element
 */
...
public class Keyword {
	...
	public static RemoteWebDriver driver = threadLocal.get();
